...
const FOUNDER_HELP: HelpContent = {
  ...
  description: 'This is your strategic command center for Fractional Foundry. Monitor OKRs, financials, TU (Time Unit) efficiency, team performance, and orchestration health. Your super-lean company operates on 4-hour Time Units and orchestrates suppliers rather than manufacturing in-house.',
  tips: [
    'Check "Attention Required" daily for urgent items like late engagements, disputes, or capacity shortfalls',
    'Monitor runway and TU efficiency—AI tools boost effective output per TU allocated (speed × quality × flow)',
    'Use the TU Analytics button (purple Gauge) for deep insights into team efficiency, forecasting, and AI ROI',
    'Review pending approvals and orchestration milestones to unblock suppliers and team',
    'Equip your team with AI tools via Hub tab—each person has 5 slots: Think/Create/Verify/Execute/Ops',
    'Track engagements in Make tab—"Done" means Accepted with evidence, NOT just shipped',
  ],
  quickActions: [
    { label: 'TU Analytics', description: 'Access Time Unit dashboard: efficiency, variance, AI ROI, forecasting, and optimization opportunities' },
    { label: 'Financial Dashboard', description: 'Tap runway indicator for detailed metrics including TU costs, AI tool licensing, and engagement financials' },
    { label: 'Review OKRs', description: 'Navigate to Decide tab to review strategic objectives and allocate TU capacity' },
    { label: 'AI Loadout Management', description: 'Visit Hub tab to assess AI readiness, equip tools per person, and view team productivity multipliers' },
    { label: 'Orchestration Health', description: 'Check Make tab for supplier engagement status, acceptance gates, and cash at risk' },
  ],
};
...
const EXECUTIVE_HELP: HelpContent = {
  ...
  description: 'As a Fractional Executive, you oversee one of the five business functions (Build/Make/Sell/Serve/Ops). Manage your apprentices, allocate TU capacity, equip AI tools to boost productivity, and coordinate engagements with suppliers. You work 2 TU per day (8 hours) across the days you\'re scheduled.',
  tips: [
    'Review apprentice work daily—TU efficiency improves with rapid feedback cycles',
    'Equip your team with AI tools matched to their readiness score—tools multiply effective output per TU',
    'Keep pending reviews under 3 days to maintain team velocity and avoid blocked time',
    'For Make function: Track supplier engagements, milestone progress, and acceptance gates',
    'Use TU Analytics to identify skill mismatches or underutilization in your function',
    'AI tools in your loadout (Think/Create/Verify/Execute/Ops) boost your own productivity too',
  ],
  quickActions: [
    { label: 'Review Work Plans', description: 'Check and approve work submitted by apprentices in your function' },
    { label: 'AI Tools & Loadout', description: 'Assess your team\'s AI readiness and equip tools to increase speed, quality, and flow' },
    { label: 'TU Allocation', description: 'Allocate Time Units to tasks in Decide tab—ensure skills match task requirements' },
    { label: 'Track Function OKRs', description: 'Monitor progress on objectives owned by your business function' },
    { label: 'Orchestration (Make)', description: 'If you\'re the Make exec: manage supplier engagements, milestones, QC gates, and acceptance' },
  ],
};
...
const APPRENTICE_HELP: HelpContent = {
  ...
  description: 'This is your personal workspace where you execute tasks, track progress on OKRs, and grow your skills. You have 10 TU (Time Units) per week—each TU is 4 hours of focused work. AI tools equipped in your loadout boost your effective output per TU, making you faster and more effective.',
  tips: [
    'Focus on tasks linked to your function\'s OKRs—this drives strategic impact',
    'Update work progress regularly so your executive can track status and provide feedback',
    'Use AI tools matched to your readiness—they multiply your speed, quality, and flow per TU',
    'Take the AI Readiness Assessment in Hub tab to unlock more powerful tools',
    'If blocked, reach out to your executive immediately—blocked time wastes TU capacity',
    'Check TU Analytics to see your efficiency metrics and areas for improvement',
  ],
  quickActions: [
    { label: 'View My Work', description: 'See all your active tasks, allocated TU, and deadlines in Decide tab' },
    { label: 'AI Tools & Assessment', description: 'Take the AI readiness quiz and equip tools in your 5 loadout slots to boost productivity' },
    { label: 'TU Analytics', description: 'View your Time Unit efficiency, task performance, and AI tool impact' },
    { label: 'Contact My Team', description: 'Message your executive or team members to unblock work or coordinate' },
    { label: 'Track OKR Progress', description: 'Monitor how your tasks contribute to function and company objectives' },
  ],
};
